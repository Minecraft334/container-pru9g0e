...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-pru9g0e.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-pru9g0e.containers.anotherwebservice.com/
...
```
git clone git@github.com:Minecraft334/container-pru9g0e.git
cd container-pru9g0e
```
...
```
docker attach container-pru9g0e
```
